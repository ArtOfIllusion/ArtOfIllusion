...
public class ObjectPropertiesPanel extends ColumnContainer
{
  ...
  protected void rebuildContents()
  {
    ...
    if (canSetTexture)
    {
      ...
      textureChoice.setModel(new DefaultComboBoxModel<String>(names.toArray(new String[names.size()])));
    ...
    if (canSetMaterial)
    {
      ...
      materialChoice.setModel(new DefaultComboBoxModel<String>(names.toArray(new String[names.size()])));
